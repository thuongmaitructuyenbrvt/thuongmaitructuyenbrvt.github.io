...
(function($){
  ...
  // Hero Enlarge on Scroll
  $(window).scroll( function() {
    $(".gallery-hero").css("transform", "scale(" + ($(this).scrollTop() / 1800 + 1) + ")");
  });
  ...
  $hamburger_menu.click(function() {
    ...
    if ($body.hasClass('mobile-menu')) {
      $main_nav.find($logo).find('img').attr('src','https://khuongitvtbadboy.github.io/image/logoamp.png');
    } else if (!$body.hasClass('mobile-menu') &&  $main_nav.hasClass('transparent-header') &&  !$main_nav.hasClass('et_fixed_nav')) {
      $transparent_header.find($logo).find('img').attr('src','https://khuongitvtbadboy.github.io/image/logoamp.png');
    }
  });
